            ...
            <mj-column width="100%">
              ...
              <mj-text color="#637381" font-size="16px">
                <ul>
                  ...
                  <li style={{ paddingBottom: "20px" }}>
                    <strong>Quia a assumenda nulla:</strong> Repudiandae
                    accusamus obcaecati voluptatibus accusantium perspiciatis.
                  </li>
                  <li>
                    <strong>Tempora culpa porro labore:</strong> In quisquam
                    optio quibusdam fugiat perspiciatis nobis.
                  </li>
                </ul>
              </mj-text>
              <mj-text color="#637381" font-size="16px" padding-bottom="30px">
                Lorem ipsum dolor{" "}
                <a class="text-link" href="https://google.com">
                  sit amet consectetur
                </a>{" "}
                adipisicing elit. Earum eaque sunt nulla in, id eveniet quae
                unde ad ipsam ut, harum autem porro reiciendis minus libero
          ...
          <mj-section>
            <mj-column width="100%" padding="0">
              ...
              >
                ...
                registered with Croft's Accountants. (123 Main Street, Austin,
                TX 78701) and agreed to receive emails from us regarding new
            ...
            <mj-group>
              <mj-column width="100%" padding-right="0">
                <mj-text
                  ...
                  font-weight="bold"
                >
                  <a class="footer-link" href="https://www.google.com">
                    Privacy
                  </a>
                  &#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;
                  <a class="footer-link" href="https://www.google.com">
